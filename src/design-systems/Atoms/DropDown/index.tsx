...
const DropDown: React.FC<DropDownProps> = ({
  ...
  return (
    <div className="relative z-10   h-[64px] w-full">
      <div
        className={`border-lightGray group absolute z-[99999999] block h-fit w-full items-start rounded-lg border-[0.5px]  px-3 py-2 hover:bg-neutral-800 hover:-h-[300px] overflow-auto ${className} max-h-[350px] overflow-auto`}
        onMouseEnter={handleHover}
        onMouseLeave={handleLeaveHover}
      >
        <div className="flex items-center justify-between gap-2">
          <Typography className="text-base font-medium text-[#BABABA]">
            {value.name}
          </Typography>
          <DropDownIcon
            stroke="text-white"
